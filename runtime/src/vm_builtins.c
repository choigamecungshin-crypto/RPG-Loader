...
#ifdef PLATFORM_ANDROID
    // Video
    VM_registerBuiltin(ctx, "video_open", AndroidVideo_open);
    VM_registerBuiltin(ctx, "video_close", AndroidVideo_close);
    VM_registerBuiltin(ctx, "video_draw", AndroidVideo_draw);
    VM_registerBuiltin(ctx, "video_get_status", AndroidVideo_getStatus);
    VM_registerBuiltin(ctx, "video_get_format", AndroidVideo_getFormat);
    VM_registerBuiltin(ctx, "video_enable_loop", AndroidVideo_enableLoop);
    VM_registerBuiltin(ctx, "video_set_volume", AndroidVideo_setVolume);
    VM_registerBuiltin(ctx, "video_pause", AndroidVideo_pause);
    VM_registerBuiltin(ctx, "video_resume", AndroidVideo_resume);
    VM_registerBuiltin(ctx, "video_get_position", AndroidVideo_getPosition);
    VM_registerBuiltin(ctx, "video_get_duration", AndroidVideo_getDuration);
    VM_registerBuiltin(ctx, "video_end", AndroidVideo_end);
#endif
